...
// Takes 2 1D vector references and returns f64 dot product
...
// All algebraic operations are O(total elements * stride.len())
// TODO
// Could be optimized with pointer arithmetic and f64x2, next version
pub fn add(arr1: &NdArray, arr2: &NdArray) -> Result<NdArray,String> {
    ...
    for _i in 0..total_elements {
        ...
        // Since memory is already allocated this operation is O(1)
        data.push(val1 + val2);
